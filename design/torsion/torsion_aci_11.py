...
def calculate_aci_11_torsion(
    ...
    clauses = make_clause_map(
        threshold_check="ACI 318-11 11.5.1",
        cross_section_limit="ACI 318-11 11.5.3.1",
        transverse_strength="ACI 318-11 11.5.3.3",
        longitudinal_strength="ACI 318-11 11.5.3.7",
        min_transverse="ACI 318-11 11.5.5.1-11.5.5.2",
        min_longitudinal="ACI 318-11 11.5.5.3",
        spacing_limit="ACI 318-11 11.5.6.1",
    )
